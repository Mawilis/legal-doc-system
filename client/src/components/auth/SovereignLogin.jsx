...
const panelStyle = { width: 'min(1120px, 100%)', minHeight: 0, height: 'auto', boxSizing: 'border-box', padding: 'clamp(28px, 3.2vh, 32px) clamp(52px, 4vw, 64px) 24px', background: 'linear-gradient(145deg, #1c1e20, #141617)', border: '1px solid rgba(213,176,79,.3)', borderRadius: '16px', boxShadow: '0 30px 90px rgba(0,0,0,.42)' };
