  ...
  return (
    <div className="flex items-center justify-center h-full w-full bg-black">
      <div className="text-center p-8">
        <h1 className="text-2xl font-black text-yellow-500 uppercase mb-4">FINANCE DASHBOARD</h1>
        <p className="text-stone-400">Revenue analytics and financial intelligence</p>
