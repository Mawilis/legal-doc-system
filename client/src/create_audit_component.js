...
console.log('🛠️ CREATING AUDIT UI COMPONENT...');

// 1. Ensure Directory Exists
const dir = path.join(__dirname, 'features/documents/components');
if (!fs.existsSync(dir)){
    fs.mkdirSync(dir, { recursive: true });
    console.log('✅ Created directory: features/documents/components');
}
...
// 3. Write the File
fs.writeFileSync(path.join(dir, 'AuditTrail.jsx'), componentCode);
console.log("✅ COMPONENT CREATED: AuditTrail.jsx");
