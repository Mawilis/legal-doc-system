 ...
 * VERSION: v1.0.0-R10E59-PASSWORD-RECOVERY-CLIENT-FLOW-CERT
 ...
 * CHANGELOG: v1.0.0-R10E59-PASSWORD-RECOVERY-CLIENT-FLOW-CERT — Adds direct client-flow evidence for generic 202
...
describe('R10E59 password recovery client flow certificate', () => {
  beforeEach(() => {
    navigate.mockReset();
  ...
  it('scrubs verification capability from the address bar before explicit completion', async () => {
    ...
    render(
      <MemoryRouter initialEntries={[
        '/verify-recovery-contact#tenant=TENANT-R10E59&verification=verify-secret-r10e59',
      ]}>
  ...
  it('rejects incomplete verification links without invoking verification transport', () => {
    render(
      <MemoryRouter initialEntries={['/verify-recovery-contact#tenant=TENANT-R10E59']}>
        <RecoveryContactVerificationPortal />
      </MemoryRouter>,
    );
  ...
  it('scrubs reset capability, hides manual recovery input, and submits the exact link capability', async () => {
    ...
    render(
      <MemoryRouter initialEntries={[
        '/reset-password#tenant=TENANT-R10E59&recovery=reset-secret-r10e59',
      ]}>
        <PasswordResetPortal />
      </MemoryRouter>,
    );
