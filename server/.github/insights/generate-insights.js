...
async function generateInsights() {
  ...
  await fs.writeFile(path.join(__dirname, 'latest-insights.json'), JSON.stringify(report, null, 2));
...
`;
  ...
  await fs.writeFile(path.join(__dirname, 'latest-insights.md'), markdown);
