...
describe('Client Onboarding Service - Integration Tests', () => {
  ...
  test('[TC-002] should get session', async () => {
    ...
    await clientOnboardingService.createSession(sessionId, tenantId, clientType, initialData);
  ...
  test('[TC-003] should update session data', async () => {
    ...
    await clientOnboardingService.createSession(sessionId, tenantId, clientType, {
      firstName: 'John',
      lastName: 'Doe',
      idNumber: '9001011234567',
      dateOfBirth: '1990-01-01',
  ...
  test('[TC-009] should enforce tenant isolation', async () => {
    ...
    await clientOnboardingService.createSession(sessionId1, tenantId1, clientType, {
      firstName: 'Tenant1',
      lastName: 'User',
      idNumber: '9001011234567',
      dateOfBirth: '1990-01-01',
    ...
    await clientOnboardingService.createSession(sessionId2, tenantId2, clientType, {
      firstName: 'Tenant2',
      lastName: 'User',
      idNumber: '9001011234567',
      dateOfBirth: '1990-01-01',
