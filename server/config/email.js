...
const emailTemplates = {
  paiaRequestConfirmation: {
    ...
    footer:
      'This communication contains confidential information. If you are not the intended recipient, please notify us immediately. POPIA compliance assured.',
    retentionDays: 365,
  },
  paiaResponse: {
    ...
    footer:
      'This response is sent in compliance with PAIA Section 25. Records retained for 5 years.',
    retentionDays: 1825,
  },
  annualReturnReminder: {
    ...
    footer:
      'Companies Act Section 33 requires annual returns within 12 months of financial year end.',
    retentionDays: 2555,
  },
  directorValidation: {
  ...
  securityAlert: {
    ...
    footer:
      'If you did not authorize this access, please contact your system administrator immediately.',
    retentionDays: 365,
  },
};
