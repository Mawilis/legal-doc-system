  ...
  apps: [
    {
      ...
      deploy: {
        production: {
          ...
          'post-deploy': 'npm ci --production && pm2 reload ecosystem.config.js --only wilsy-os && pm2 save',
        ...
        staging: {
          ...
          ssh_options: 'StrictHostKeyChecking=no',
          'post-deploy': 'npm ci && pm2 reload ecosystem.config.js --only wilsy-os --env staging && pm2 save',
          env: {
            NODE_ENV: 'staging',
          },
        },
