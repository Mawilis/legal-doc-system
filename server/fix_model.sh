...
CaseSchema.statics.findByTenant = function(tenantId) { 
    return this.find({ tenantId }); 
};

CaseSchema.statics.addPaiaRequest = async function(caseId, paiaData) {
...
echo "✅ Case.js has been surgically repaired."
