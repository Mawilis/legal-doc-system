...
describe('Case Model Comprehensive Tests', () => {
    ...
    // PRO-GRADE BYPASS: Go directly to the mongo driver attached to mongoose
    ...
    beforeAll(async () => {
        ...
        // Ensure we load the model AFTER the connection
...
echo "✅ Case.test.js patched with Mongoose-Bypass ID Generator."
