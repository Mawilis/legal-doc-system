...
// 2. INSTANTIATE MODEL AT TOP LEVEL
// This prevents Jest from re-registering it inside hooks
const Case = mongoose.models.SovereignCase || mongoose.model('SovereignCase', CaseSchema);
...
echo "✅ Case.test.js updated with Global Injection logic."
