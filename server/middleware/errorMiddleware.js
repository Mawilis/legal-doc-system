...
const POPIA_CODES = Object.freeze({
  CONSENT_MISSING: {
    status: 403,
    message: 'POPIA Section 11: Consent required for processing',
    code: 'POPIA_CONSENT_MISSING',
  },
  PURPOSE_VIOLATION: {
    status: 403,
    message: 'POPIA Section 13: Processing purpose violation',
    code: 'POPIA_PURPOSE_VIOLATION',
  },
  DATA_MINIMIZATION: {
    status: 400,
    message: 'POPIA Section 10: Excessive data collection',
    code: 'POPIA_DATA_MINIMIZATION',
  },
  RETENTION_EXCEEDED: {
    status: 403,
    message: 'POPIA Section 14: Retention period exceeded',
    code: 'POPIA_RETENTION_EXCEEDED',
  },
  SECURITY_BREACH: {
    status: 500,
    message: 'POPIA Section 19: Security safeguards violated',
    code: 'POPIA_SECURITY_BREACH',
  },
  DATA_SUBJECT_RIGHTS: {
    status: 403,
    message: 'POPIA Section 23: Data subject rights violation',
    code: 'POPIA_DATA_SUBJECT_RIGHTS',
  },
  CROSS_BORDER: {
    status: 403,
    message: 'POPIA Section 72: Cross-border transfer violation',
    code: 'POPIA_CROSS_BORDER',
  },
  SPECIAL_CATEGORY: {
    status: 403,
    message: 'POPIA Section 26: Special category data violation',
    code: 'POPIA_SPECIAL_CATEGORY',
  },
  CHILDREN_DATA: {
    status: 403,
    message: "POPIA Section 34: Children's data violation",
    code: 'POPIA_CHILDREN_DATA',
  },
});
...
const PAIA_CODES = Object.freeze({
  REQUEST_INVALID: {
    status: 400,
    message: 'PAIA Section 11: Invalid access request',
    code: 'PAIA_REQUEST_INVALID',
  },
  RESPONSE_OVERDUE: {
    status: 408,
    message: 'PAIA Section 25: Response deadline exceeded',
    code: 'PAIA_RESPONSE_OVERDUE',
  },
  MANUAL_UNAVAILABLE: {
    status: 404,
    message: 'PAIA Section 14: PAIA manual not available',
    code: 'PAIA_MANUAL_UNAVAILABLE',
  },
});
...
const FICA_CODES = Object.freeze({
  KYC_REQUIRED: {
    status: 403,
    message: 'FICA Section 21: KYC verification required',
    code: 'FICA_KYC_REQUIRED',
  },
  AML_SCREENING: {
    status: 403,
    message: 'FICA Section 29: AML screening required',
    code: 'FICA_AML_SCREENING',
  },
  SUSPICIOUS_ACTIVITY: {
    status: 403,
    message: 'FICA Section 28: Suspicious activity detected',
    code: 'FICA_SUSPICIOUS',
  },
  CDD_FAILED: {
    status: 403,
    message: 'FICA: Customer due diligence failed',
    code: 'FICA_CDD_FAILED',
  },
});
...
const CYBERCRIMES_CODES = Object.freeze({
  UNAUTHORIZED_ACCESS: {
    status: 403,
    message: 'Cybercrimes Act Section 2: Unauthorized access attempt',
    code: 'CYBER_UNAUTHORIZED_ACCESS',
  },
  INTERCEPTION: {
    status: 403,
    message: 'Cybercrimes Act Section 3: Unlawful interception',
    code: 'CYBER_INTERCEPTION',
  },
  FRAUD: {
    status: 403,
    message: 'Cybercrimes Act Section 4: Cyber fraud detected',
    code: 'CYBER_FRAUD',
  },
  EVIDENCE_PRESERVATION: {
    status: 500,
    message: 'Cybercrimes Act: Evidence preservation failed',
    code: 'CYBER_EVIDENCE_FAILED',
  },
});
...
const COMPANIES_ACT_CODES = Object.freeze({
  RETENTION_VIOLATION: {
    status: 403,
    message: 'Companies Act Section 28: Records retention violation',
    code: 'COMPANIES_RETENTION',
  },
  CIPC_FILING: {
    status: 403,
    message: 'Companies Act Section 30: CIPC filing required',
    code: 'COMPANIES_CIPC_REQUIRED',
  },
  ANNUAL_RETURN: {
    status: 403,
    message: 'Companies Act: Annual return overdue',
    code: 'COMPANIES_ANNUAL_RETURN',
  },
});
...
const ECT_ACT_CODES = Object.freeze({
  SIGNATURE_INVALID: {
    status: 403,
    message: 'ECT Act Section 13: Invalid electronic signature',
    code: 'ECT_SIGNATURE_INVALID',
  },
  NON_REPUDIATION: {
    status: 403,
    message: 'ECT Act Section 15: Non-repudiation requirement',
    code: 'ECT_NON_REPUDIATION',
  },
  DATA_MESSAGE: {
    status: 400,
    message: 'ECT Act Section 12: Invalid data message',
    code: 'ECT_DATA_MESSAGE',
  },
});
...
const SARS_CODES = Object.freeze({
  ...
  TAX_COMPLIANCE: {
    status: 403,
    message: 'SARS: Tax compliance certificate required',
    code: 'SARS_TAX_COMPLIANCE',
  },
  EFILING_FAILED: {
    status: 500,
    message: 'SARS: eFiling submission failed',
    code: 'SARS_EFILING_FAILED',
  },
});
...
const LPC_CODES = Object.freeze({
  TRUST_ACCOUNT: {
    status: 403,
    message: 'LPC: Trust account violation',
    code: 'LPC_TRUST_ACCOUNT',
  },
  FIDELITY_FUND: {
    status: 403,
    message: 'LPC: Fidelity fund contribution required',
    code: 'LPC_FIDELITY_FUND',
  },
  AUDIT_REQUIRED: {
    status: 403,
    message: 'LPC: Annual audit required',
    code: 'LPC_AUDIT_REQUIRED',
  },
});
...
const GDPR_CODES = Object.freeze({
  CONSENT_WITHDRAWN: {
    status: 403,
    message: 'GDPR Article 7: Consent withdrawn',
    code: 'GDPR_CONSENT_WITHDRAWN',
  },
  RIGHT_TO_ERASURE: {
    status: 403,
    message: 'GDPR Article 17: Right to erasure request pending',
    code: 'GDPR_RIGHT_TO_ERASURE',
  },
  DATA_PORTABILITY: {
    status: 400,
    message: 'GDPR Article 20: Data portability format invalid',
