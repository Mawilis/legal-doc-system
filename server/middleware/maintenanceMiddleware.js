    ...
    try {
      ...
      if (req.user && req.user.role) {
        ...
        if (
          ...
          logger.info('Maintenance bypass via req.user role', {
            role,
            correlationId,
      ...
      if (verifyToken) {
        try {
          ...
          if (token) {
            ...
            if (secret) {
              ...
              if (
                ...
                logger.info('Maintenance bypass via verified token role', {
                  role,
                  correlationId,
          ...
          logger.warn('Maintenance middleware token verification failed', {
