...
export const getMetrics = (req, res) => {
    const averageLatency = metrics.responses > 0 
        ? metrics.totalLatency / metrics.responses 
        : 0;
    ...
    res.json({
        ...
        errorRate: metrics.responses > 0 ? (metrics.errors / metrics.responses * 100).toFixed(2) + '%' : '0%',
