...
const SEVERITY_ENUM = Object.freeze(['INFO', 'LOW', 'MEDIUM', 'HIGH', 'CRITICAL']);
  ...
  return this.aggregate([
    ...
    },
    {
      $project: {
        ...
        countries: 1,
        attackDurationHours: {
          $divide: [{ $subtract: ['$lastSeen', '$firstSeen'] }, 1000 * 60 * 60],
        },
  ...
  return this.aggregate([
            ...
            $cond: [
              {
                $in: [
                  '$eventType',
                  ['SENSITIVE_DATA_ACCESS', 'DATA_EXFILTRATION_ATTEMPT', 'PII_EXPOSURE_ATTEMPT'],
                ],
              },
              1,
              0,
    ...
    },
    {
      $project: {
        ...
        dataBreaches: 1,
        mitigationRate: {
          $multiply: [{ $divide: ['$mitigatedCount', '$totalEvents'] }, 100],
        },
      },
    },
