...
const TaxRecordSchema = new mongoose.Schema(
  {
    ...
    period: {
      type: String,
      enum: ['ANNUAL', 'MONTHLY', 'QUARTERLY', 'BI-ANNUAL'],
      default: 'ANNUAL',
    },
    filingDate: {
    ...
    retentionPolicy: {
      type: String,
      enum: ['tax_act_5_years', 'companies_act_7_years', 'permanent'],
...
TaxRecordSchema.statics.getEconomicMetrics = async function (tenantId) {
  ...
  return {
    ...
    paymentRate:
      stats.totalAmountDue > 0 ? (stats.totalAmountPaid / stats.totalAmountDue) * 100 : 100,
  };
};
