 ...
 */
complianceEventSchema.post('save', (doc) => {
...
const complianceEventJoiSchema = joi.object({
  complianceCategory: joi
    .string()
    .valid(...Object.keys(COMPLIANCE_CATEGORIES))
    .required()
  ...
  severity: joi
    .string()
    .valid(...Object.keys(EVENT_SEVERITY))
    .default('INFO')
  ...
  outcome: joi
    .string()
    .valid('SUCCESS', 'FAILURE', 'PARTIAL', 'PENDING', 'REVERSED')
    .default('SUCCESS')
    .label('Event Outcome'),
});
