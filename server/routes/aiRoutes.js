...
const batchAnalysisSchema = {
  ...
  callbackUrl: validateSchema
    .string()
    .uri()
    .optional()
    .description('Webhook URL for async processing results'),

  batchReference: validateSchema
    .string()
    .max(100)
    .optional()
