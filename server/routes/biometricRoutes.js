...
const biometricRegistrationLimiter = rateLimit({
  ...
  message: {
    status: 'error',
    message:
      'Too many biometric registration attempts. Please contact support if you need to register more devices.',
    compliance: {
...
router.post(
  ...
  [
    ...
    body('clientData').optional().isObject().withMessage('Client data must be an object'),
  ],
