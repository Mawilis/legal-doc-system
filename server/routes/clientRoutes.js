...
router.post(
  ...
  rateLimit({
    windowMs: 3600000,
    max: 100,
    message: 'Too many client creation attempts. Please wait.',
  }),
  protect,
  verify2FA,
  tenantGuard(),
...
router.patch(
  ...
  rateLimit({
    windowMs: 3600000,
    max: 50,
    message: 'Too many FICA verification attempts. Please wait.',
  }),
  protect,
  verify2FA,
  tenantGuard(),
...
router.post(
  ...
  rateLimit({
    windowMs: 3600000,
    max: 5,
    message: 'Too many bulk import attempts. Please wait 1 hour.',
  }),
  protect,
  verify2FA,
  tenantGuard(),
