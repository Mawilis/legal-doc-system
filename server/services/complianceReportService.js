...
const SA_COMPLIANCE_FRAMEWORKS = {
  ...
  PAIA: {
    ...
    FEE_STRUCTURE: {
      REPRODUCTION_PER_PAGE: 1.5,
      SEARCH_PER_HOUR: 35.0,
      DEPOSIT_PER_PAGE: 0.1,
    },
  },
  ECT_ACT: {
...
class POPIAComplianceNexus {
  ...
  static validateLawfulProcessing(dataProcessing) {
    const conditions = [
      ...
      },
      {
        ...
        validation: () => !!dataProcessing.purpose && dataProcessing.purpose.length > 0,
        weight: 0.15,
      },
      {
        id: 4,
      ...
      },
      {
        ...
        validation: () => dataProcessing.dataQualityChecked && dataProcessing.accuracyVerified,
        weight: 0.1,
      },
      {
        id: 6,
        ...
        validation: () => dataProcessing.documented && dataProcessing.dataSubjectNotified,
        weight: 0.1,
      },
      {
        id: 7,
        ...
        validation: () => dataProcessing.encrypted && dataProcessing.accessControlled,
        weight: 0.15,
      },
      {
        id: 8,
        ...
        validation: () => dataProcessing.rightsRespected && dataProcessing.accessMechanism,
        weight: 0.05,
      },
    ];
  ...
  static validateConsent(consent) {
    const schema = Joi.object({
      ...
      method: Joi.string().valid('DIGITAL_SIGNATURE', 'CHECKBOX', 'VERBAL', 'WRITTEN').required(),
...
class FICAKYCNexus {
  ...
  static checkFICACompliance(verificationData) {
    const requirements = [
      ...
      verificationData.occupationVerified || verificationData.employmentStatusVerified,
    ];
...
class ComplianceReportService {
  ...
  async analyzePOPIACompliance(startDate, endDate, firmId) {
    ...
    try {
      ...
      const result = {
        ...
        recommendations:
          complianceRate < this.complianceThreshold
  ...
  async analyzeFICACompliance(startDate, endDate, firmId) {
    ...
    try {
      ...
      const result = {
        ...
        recommendations: kycCoverage < 95 ? ['Complete KYC verification for all clients'] : [],
      };
  ...
  async analyzeECTActCompliance(startDate, endDate, firmId) {
    try {
      ...
      return {
        ...
        recommendations:
          digitalSignatureRate < 80 ? ['Implement digital signatures for all legal documents'] : [],
      };
    } catch (error) {
  ...
  async analyzeCPACompliance(startDate, endDate, firmId) {
    try {
      ...
      return {
        ...
        recommendations: complianceRate < 95 ? ['Review agreement terms for CPA compliance'] : [],
      };
    } catch (error) {
  ...
  async analyzeCybercrimesCompliance(startDate, endDate, firmId) {
    try {
      ...
      return {
        ...
        recommendations: reportingRate < 100 ? ['Report all cyber incidents to authorities'] : [],
      };
    } catch (error) {
  ...
  async verifyDataResidencyCompliance(firmId) {
    try {
      ...
      return {
        ...
        recommendations: !isInSouthAfrica ? ['Migrate data to AWS Africa (Cape Town) region'] : [],
      };
    } catch (error) {
  ...
  async updateComplianceScores() {
    ...
    try {
      const scores = await this.analyzePOPIACompliance(oneWeekAgo, new Date(), 'system');
  ...
  calculateAverageAMLRisk(verifications) {
    ...
    const totalRisk = verifications.reduce((sum, v) => sum + (v.amlRiskScore || 0), 0);
