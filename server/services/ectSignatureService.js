...
class ECTSignatureService {
  ...
  _generateDeviceFingerprint(requestData = {}) {
    ...
    return crypto.createHash('sha256').update(fingerprintString).digest('hex').substring(0, 32); // First 32 chars for readability
  }
...
const ECTSignatureSchemas = {
  ...
  SIGNATORY_SCHEMA: Joi.object({
    ...
    capacityType: Joi.string()
      ...
      .default('INDIVIDUAL'),
    representedEntity: Joi.string()
      .optional()
      .description('Entity being represented if applicable'),
  ...
  DOCUMENT_SCHEMA: Joi.object({
    ...
    encryptionRequired: Joi.boolean()
      .default(true)
      .description('Whether document requires encryption'),
