...
class LanguageService {
  constructor() {
    ...
    this.constitutionalLanguages = ['zu', 'xh', 'af', 'nso', 'tn', 'ts', 'ss', 've', 'nr', 'en'];
  }
   ...
   */
  validateEnvironment() {
    const requiredEnvVars = ['DEFAULT_LOCALE', 'REDIS_URL', 'TRANSLATION_API_KEY'];
  ...
  getLegalDisclaimers(locale, documentType) {
    const disclaimers = {
      ...
      'af-ZA': {
        ...
        electronic:
          'Hierdie elektroniese handtekening is geldig ingevolge die ECT Wet 25 van 2002.',
