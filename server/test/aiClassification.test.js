...
describe('🤖 AI Document Classification Test Suite', function () {
  ...
  describe('1. Classification Service - Unit Tests', () => {
    it('should correctly classify an ID document', async () => {
      ...
      const result = await ClassificationService.classify(mockText, 'ID_DOCUMENT', {
        audit: AuditService,
      });
    ...
    it('should correctly classify a proof of address', async () => {
      ...
      const result = await ClassificationService.classify(mockText, 'PROOF_OF_ADDRESS', {
        audit: AuditService,
      });
    ...
    it('should correctly classify a company registration', async () => {
      ...
      const result = await ClassificationService.classify(mockText, 'COMPANY_REGISTRATION', {
        audit: AuditService,
      });
    ...
    it('should handle empty text', async () => {
      const result = await ClassificationService.classify('', 'ID_DOCUMENT', {
        audit: AuditService,
      });
