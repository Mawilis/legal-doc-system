...
describe('CaseAnalysisService - Investor Grade Suite v2.0', () => {
  let service;
  let mockRedisClient;
  ...
  describe('📊 INVESTOR METRICS VALIDATION', () => {
    it('should calculate R4.2M/year ROI', () => {
  ...
  describe('🏛️ COURT HIERARCHY VALIDATION', () => {
    ...
    it('should validate Small Claims Court jurisdiction', () => {
    ...
    it('should reject Small Claims Court for companies', () => {
      const validator = new CourtJurisdictionValidator();
      const caseData = {
        claimAmount: 15000,
        partyType: 'COMPANY',
    ...
    it('should validate District Magistrate Court jurisdiction', () => {
      const validator = new CourtJurisdictionValidator();
      const caseData = {
        claimAmount: 150000,
        offenceType: 'theft',
    ...
    it('should reject murder in District Magistrate Court', () => {
      const validator = new CourtJurisdictionValidator();
      const caseData = {
        offenceType: 'murder',
      };
    ...
    it('should get correct appeal path', () => {
      const validator = new CourtJurisdictionValidator();
  ...
  describe('🔍 Case Analysis', () => {
    ...
    it('should analyze case with cache miss', async () => {
  ...
  describe('📈 Performance Metrics', () => {
    it('should process analysis within 500ms', async () => {
      mockRedisClient.get.resolves(null);
  ...
  describe('🔧 Utility Methods', () => {
    it('should get court info by type', () => {
