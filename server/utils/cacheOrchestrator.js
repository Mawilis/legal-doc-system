...
class QuantumCacheOrchestrator {
  ...
  containsExcessivePII(data) {
    ...
    const piiCount = piiIndicators.filter((indicator) => jsonString.includes(indicator)).length;
    ...
    try {
      ...
      return {
        ...
        keys: {
          ...
          sessions: (await this.client.keysAsync(`${CACHE_QUANTUM.NAMESPACES.USER_SESSIONS}*`))
            .length,
        },
