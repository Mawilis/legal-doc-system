...
const encryptData = (data, tenantId, options = {}) => {
  ...
  const cipher = crypto.createCipheriv(ENCRYPTION_CONSTANTS.ALGORITHM, encryptionKey, iv, {
...
const decryptData = (encryptedData, tenantId, options = {}) => {
  ...
  try {
    ...
    // Create decipher
    const decipher = crypto.createDecipheriv(ENCRYPTION_CONSTANTS.ALGORITHM, encryptionKey, iv, {
      authTagLength: ENCRYPTION_CONSTANTS.TAG_LENGTH,
    });
