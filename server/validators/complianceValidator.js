...
const FICA_SCHEMA = Joi.object({
  ...
  // Proof of Address
  proofOfAddressType: Joi.string()
    .valid('UTILITY_BILL', 'BANK_STATEMENT', 'RENTAL_AGREEMENT', 'MUNICIPAL_ACCOUNT')
    .required(),
  ...
  sourceOfFunds: Joi.string()
    .valid('EMPLOYMENT', 'BUSINESS', 'INVESTMENTS', 'INHERITANCE', 'GIFT', 'OTHER')
    .required(),
  ...
  // Ongoing Monitoring
  monitoringFrequency: Joi.string().valid('ANNUAL', 'BI_ANNUAL', 'QUARTERLY', 'MONTHLY').required(),
