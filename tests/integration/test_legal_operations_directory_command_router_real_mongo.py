...
VERSION: v1.0.3-L8-1-LEGAL-OPERATIONS-DIRECTORY-COMMAND-RM-CERT
...
CHANGELOG: 2026-09-23 v1.0.3-L8-1-LEGAL-OPERATIONS-DIRECTORY-COMMAND-RM-CERT
...
def test_real_mongo_directory_rows_exclude_financial_authority(
    ...
    assert VERSION == (
        "v1.0.3-L8-1-LEGAL-OPERATIONS-DIRECTORY-COMMAND-RM-CERT"
    )
