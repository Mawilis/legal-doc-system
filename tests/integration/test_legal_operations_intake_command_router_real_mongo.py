...
VERSION: v1.0.0-L8-2-LEGAL-OPERATIONS-INTAKE-COMMAND-RM-CERT
...
CHANGELOG: 2026-09-23 v1.0.0-L8-2-LEGAL-OPERATIONS-INTAKE-COMMAND-RM-CERT
...
def test_real_mongo_intake_rows_exclude_downstream_and_financial_authority(
    ...
    assert command_api.VERSION == (
        "v1.2.0-L8-2-LEGAL-OPERATIONS-INTAKE-COMMAND-API"
    )
    assert VERSION == (
        "v1.0.0-L8-2-LEGAL-OPERATIONS-INTAKE-COMMAND-RM-CERT"
    )
