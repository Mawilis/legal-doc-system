...
VERSION: v1.0.3-L8-6D-ROUTER-COMPAT-SHERIFF-OPERATIONAL-QUEUE-HTTP-CERT
...
CHANGELOG: 2026-09-23 v1.0.3-L8-6D-ROUTER-COMPAT-SHERIFF-OPERATIONAL-QUEUE-HTTP-CERT
           rebinds the sealed sheriff operational-queue certificate to the
           additive L8-6D read router; sheriff-only queue behavior and all
           existing fail-closed assertions remain unchanged.
           2026-09-23 v1.0.3-L8-6D-ROUTER-COMPAT-SHERIFF-OPERATIONAL-QUEUE-HTTP-CERT
           rebinds the sealed sheriff operational-queue certificate to the
