...
VERSION: v1.0.0-L8-6A-SHERIFF-OPERATIONAL-QUEUE-LIVE-IAM-RM-CERT
...
CHANGELOG: 2026-09-23 v1.0.0-L8-6A-SHERIFF-OPERATIONAL-QUEUE-LIVE-IAM-RM-CERT
...
def test_live_router_and_iam_bindings_match_l8_6a_release() -> None:
    ...
    assert VERSION == "v1.0.0-L8-6A-SHERIFF-OPERATIONAL-QUEUE-LIVE-IAM-RM-CERT"
