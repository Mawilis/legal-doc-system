...
VERSION: v1.0.3-L8-6B-DEPUTY-PRINCIPAL-BINDING-REGISTRY-CERT
...
CHANGELOG: 2026-09-23 v1.0.3-L8-6B-DEPUTY-PRINCIPAL-BINDING-REGISTRY-CERT
           rebinds the unchanged runtime certificate to production v1.0.4
           after static non-None collision-branch typing alignment.
           2026-09-23 v1.0.2-L8-6B-DEPUTY-PRINCIPAL-BINDING-REGISTRY-CERT
...
def test_registry_exposes_no_update_delete_rebind_or_financial_surface() -> None:
    ...
    assert PRODUCTION_VERSION == (
        "v1.0.4-L8-6B-DEPUTY-PRINCIPAL-BINDING-REGISTRY"
    )
    assert VERSION == (
        "v1.0.3-L8-6B-DEPUTY-PRINCIPAL-BINDING-REGISTRY-CERT"
    )
