...
VERSION: v1.0.2-L8-3-PROCESS-SERVICE-ACCEPTANCE-RECEIPT-CERT
...
CHANGELOG: 2026-09-23 v1.0.2-L8-3-PROCESS-SERVICE-ACCEPTANCE-RECEIPT-CERT
           rebinds the direct certificate to production v1.1.1 after the
           static-only exact replay candidate narrowing; runtime and authority
           assertions remain unchanged.
           2026-09-23 v1.0.1-L8-3-PROCESS-SERVICE-ACCEPTANCE-RECEIPT-CERT
...
def test_versions_are_frozen_to_l8_3_release() -> None:
    ...
    assert VERSION == "v1.0.2-L8-3-PROCESS-SERVICE-ACCEPTANCE-RECEIPT-CERT"
