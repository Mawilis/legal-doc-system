...
VERSION: v1.9.0-M13-P6D-WILSY-AI-CAPACITY-READ-ELIGIBILITY
...
own-tenant WILSY AI usage-capacity read eligibility and dedicated
...
CHANGELOG: 2026-09-13 v1.9.0-M13-P6D-WILSY-AI-CAPACITY-READ-ELIGIBILITY adds
...
TENANT BOUNDARY: Eligibility is own-tenant only; WILSY AI capacity-read
eligibility, membership, and target scope require separate composition.
...
WILSY AI capacity-read eligibility is non-financial. Kennel EOS remains
exclusive.
"""
