...
CHANGELOG: 2026-09-16 v1.13.0-C1B-R2 binds the dedicated reasoning operation
...
_BINDINGS = MappingProxyType({**_BINDINGS, "wilsy_ai_legal_tool_read": "wilsy_ai:legal_tool:read", "wilsy_ai_reasoning_execute": "wilsy_ai:reasoning:execute"})
