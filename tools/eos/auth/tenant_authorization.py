...
VERSION: v1.12.0-L7B-WILSY-AI-LEGAL-TOOL-BINDING
...
CHANGELOG: 2026-09-15 v1.12.0-L7B-WILSY-AI-LEGAL-TOOL-BINDING binds the
...
_BINDINGS = MappingProxyType({**_BINDINGS, "wilsy_ai_legal_tool_read": "wilsy_ai:legal_tool:read"})
