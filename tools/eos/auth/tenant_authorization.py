...
VERSION: v1.21.0-L8-7D4-CLIENT-MATTER-READ-BINDING
...
CHANGELOG: 2026-09-23 v1.21.0-L8-7D4-CLIENT-MATTER-READ-BINDING binds
...
# TENANT POSTURE: exact active principal, membership, eligible business role, exact own-tenant permission-operation pair, and active granting role are required; client matter access still requires ACTIVE visibility
