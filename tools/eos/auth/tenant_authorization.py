...
VERSION: v1.18.0-L8-6A-SHERIFF-QUEUE-READ-BINDING
...
evidence read bindings, authenticated field-service command bindings, the
sheriff-only Legal Operations directory provisioning binding, and the
sheriff-only acceptance/office-receipt binding; it does not
mutate or transport.
ABSOLUTE CANONICAL PATH: /Users/wilsonkhanyezi/legal-doc-system/tools/eos/auth/tenant_authorization.py
COLLABORATION / OWNERSHIP: Wilson Khanyezi / Wilsy Core Engineering.
CERTIFICATION/UPDATE DATE: 2026-09-23.
CHANGELOG: 2026-09-23 v1.18.0-L8-6A-SHERIFF-QUEUE-READ-BINDING binds
...
2026-09-16 v1.13.0-C1B-R2 binds the dedicated reasoning operation
to its own tenant permission without provider or model selection authority.
2026-09-15 v1.12.0-L7B-WILSY-AI-LEGAL-TOOL-BINDING binds the
authenticated field-service outcome and return operations to dedicated
permissions without transport or financial authority.
2026-09-15 v1.10.0-L7A-LEGAL-OPERATIONS-IAM-BINDING binds the
Legal Operations operations to the canonical permission namespace.
2026-09-13 v1.9.0-M14-P4-BILLING-INTELLIGENCE-EVIDENCE-READ-BINDING
adds the exact billing-intelligence evidence read operation-to-permission
binding while preserving conjunctive authorization and no new authority.
2026-09-13 v1.8.0-M13-P6D-WILSY-AI-CAPACITY-READ-BINDING binds
the exact own-tenant WILSY AI usage-capacity read operation to its canonical
permission without special-case authorization or new authority.
v1.7.0-M11-R8-R3B-P8-P3D-P4A binds four exact credential-security
...
TENANT BOUNDARY: Requires exact principal and tenant membership; WILSY AI
capacity and billing-intelligence evidence reads remain own-tenant scoped and
cross-tenant requests deny.
AUTHORITY BOUNDARY: Does not mutate repositories, parse requests, or expose transport errors.
FINANCIAL AUTHORITY BOUNDARY: Financial execution always denies; WILSY AI
capacity and billing-intelligence evidence reads are non-financial; Kennel EOS
remains exclusive.
"""
...
# TENANT POSTURE: exact active principal, membership, business role, granting role and own-tenant target are required; directory and receipt authority remain conjunctive
