...
VERSION: v1.20.0-L8-7C3B-CLIENT-VISIBILITY-WRITE-BINDING
...
Legal Operations controls, and the dedicated law-firm client-visibility
provisioning binding; it does not mutate or transport.
ABSOLUTE CANONICAL PATH: /Users/wilsonkhanyezi/legal-doc-system/tools/eos/auth/tenant_authorization.py
COLLABORATION / OWNERSHIP: Wilson Khanyezi / Wilsy Core Engineering.
CERTIFICATION/UPDATE DATE: 2026-09-23.
CHANGELOG: 2026-09-23 v1.20.0-L8-7C3B-CLIENT-VISIBILITY-WRITE-BINDING binds
...
# TENANT POSTURE: exact active principal, membership, eligible business role, granting role and exact own-tenant operation/permission pair are required
