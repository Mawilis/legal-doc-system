...
VERSION: v1.10.0-L7A-LEGAL-OPERATIONS-IAM-BINDING
...
evidence read bindings; it does not
mutate or transport.
...
CHANGELOG: 2026-09-15 v1.10.0-L7A-LEGAL-OPERATIONS-IAM-BINDING binds the
