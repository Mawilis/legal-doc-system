...
VERSION: v1.16.0-L8-1-LEGAL-OPERATIONS-DIRECTORY-BINDING
...
evidence read bindings, authenticated field-service command bindings, and the
sheriff-only Legal Operations directory provisioning binding; it does not
mutate or transport.
ABSOLUTE CANONICAL PATH: /Users/wilsonkhanyezi/legal-doc-system/tools/eos/auth/tenant_authorization.py
COLLABORATION / OWNERSHIP: Wilson Khanyezi / Wilsy Core Engineering.
CERTIFICATION/UPDATE DATE: 2026-09-23.
CHANGELOG: 2026-09-23 v1.16.0-L8-1-LEGAL-OPERATIONS-DIRECTORY-BINDING binds
...
# TENANT POSTURE: exact active principal, membership, business role, granting role and own-tenant target are required; directory provisioning remains conjunctive
